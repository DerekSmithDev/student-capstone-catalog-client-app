  ...
  <div class="home">
    <div class="container">
      ...
      <div class="row" is="transition-group" name="slide-right">
        <div v-for="capstone in orderBy(filterBy(capstones, searchFilter, 'name', 'last_name'), sortAttribute, sortOrder)" class="col-md-4 mb-2" v-bind:key="capstone.id">
            <div class="card">
            <img class="card-img-top" v-bind:src="https://cdn-images-1.medium.com/max/1200/1*08uTtDz6HD2K5dVGA-Sm0Q.png" alt="Card image cap">
            <div class="card-body">
